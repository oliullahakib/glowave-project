...
const SocialIcon = ({ Icon, href }) => (
  <motion.a
    ...
    className="w-12 h-12 rounded-2xl glass-effect flex items-center justify-center text-white/70 hover:text-glowave-primary-blue transition-colors group"
  >
...
const FooterLink = ({ to, children }) => (
  <li>
    <Link 
      to={to} 
      className="text-white/50 hover:text-glowave-primary-blue transition-all duration-300 flex items-center gap-2 group"
    >
...
const Footer = () => {
  return (
    <footer className="bg-glowave-dark-bg pt-32 pb-12 border-t border-white/5 relative overflow-hidden">
      {/* Background Glow */}
              ...
              <form className="space-y-4">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-6 text-sm focus:outline-none focus:border-glowave-primary-blue transition-colors"
                    required
                  />
                </div>
                <button 
